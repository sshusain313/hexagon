...
const GridBoard = () => {
  ...
  const buildAndDownload = async () => {
    ...
    await downloadImage('template-32.png', {
      cols: 8,
      rows: 10,
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 md:p-24">
      ...
      <div className="grid grid-cols-8 gap-1 p-6 bg-white rounded-xl shadow-2xl w-max">
      ...
      <div className="mt-2 md:mt-4 flex flex-col items-center gap-3 md:gap-4 max-w-md">
        <button
